...
if __name__ == '__main__':
    ...
    '''
    results_dir = '../../../outputs/finetune/inference/icdar_2015_test/model_finetune_1600_results/'
    evaluate_result_path = prepare_results_for_evaluation(results_dir, lexicon_type=3, cache_dir='./cache_files',
                                                          score_det=0.4, score_rec=0.4, score_rec_seq=0.5)
    p = {
        'g': "../gt.zip",
